...
function crearContentDiv() {
  contentDiv = document.createElement("div");
  contentDiv.id = "content";
  document.body.appendChild(contentDiv);
}

// Ocultar menú principal y preparar fondo para peticiones
...
// Iniciar si se llama desde el menú
if (typeof iniciarPeticiones === 'undefined') {
  var iniciarPeticiones = true;
  mostrarPreguntaInicial();
}